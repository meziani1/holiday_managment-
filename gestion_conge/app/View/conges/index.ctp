<div class="box">
    <div class="box-header">
        <h3 id="printableArea" class="box-title">Liste des conges</h3>
    </div><!-- /.box-header -->
    ...
    <div class="box-body">
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    <div class="dataTables_length" id="example1_length">
                        <!-- <?php echo $this->Form->create('Conge', array('type' => 'get', 'url' => array('action' => 'search'), 'class' => 'form-inline')); ?>
                                ...
                                <tbody>
                                    <?php foreach ($conges as $conge): ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td><?php echo h($conge['Conge']['days_remaining']) . ' jours restants'; ?></td>
                                            <td class="print-hide">
                                                <?php echo $this->Html->link('View', array('action' => 'view', $conge['Conge']['id']), array('class' => 'btn btn-xs btn-primary')); ?>
                                                <?php echo $this->Html->link('Edit', array('action' => 'edit', $conge['Conge']['id']), array('class' => 'btn btn-xs btn-warning')); ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <button onclick="printTable()" class="btn btn-primary">Imprimer la Liste</button>
                </div>
            </div>
